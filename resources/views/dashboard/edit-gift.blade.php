          ...
          <form action="{{ route('dashboard.gifts.update',$gift->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="cardS1">
                    ...
                    <input type="text" name="number_days" value="{{ old('number_days',$gift->number_days) }}" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div class="cardS2">
                <div class="inputImg">
                  <div class="icon">
                    @if (isset($gift->gift_card_image))
                    <img  id="gift_card_image-preview" src="{{ getImage('Gifts',$gift->gift_card_image) }}" alt="" />
