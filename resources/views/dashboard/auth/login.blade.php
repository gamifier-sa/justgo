...
<div class="d-flex flex-column flex-root">
    <!--begin::Page bg image-->
    <style>body { background-image: url('{{ asset('dashboard-assets') }}/media/auth/bg10.jpeg'); } [data-bs-theme="dark"] body { background-image: url('{{ asset('dashboard-assets') }}/media/auth/bg10-dark.jpeg'); }</style>
    <!--end::Page bg image-->
                    ...
                    <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('postLogin') }}" method="post">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                ...
                                <a href="{{ route('getResetPassword') }}" class="link-primary">Forgot Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Submit button-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7" data-kt-menu="true" id="kt_auth_lang_menu">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                        <span class="symbol symbol-20px me-4">
                                            <img data-kt-element="lang-flag" class="rounded-1" src="{{ asset('dashboard-assets') }}/media/flags/spain.svg" alt="" />
                                        </span>
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                        <span class="symbol symbol-20px me-4">
                                            <img data-kt-element="lang-flag" class="rounded-1" src="{{ asset('dashboard-assets') }}/media/flags/germany.svg" alt="" />
                                        </span>
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                        <span class="symbol symbol-20px me-4">
                                            <img data-kt-element="lang-flag" class="rounded-1" src="{{ asset('dashboard-assets') }}/media/flags/japan.svg" alt="" />
                                        </span>
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                        <span class="symbol symbol-20px me-4">
                                            <img data-kt-element="lang-flag" class="rounded-1" src="{{ asset('dashboard-assets') }}/media/flags/france.svg" alt="" />
                                        </span>
