@extends('superadmin.dashboard.auth.layouts.app')
@section('content')
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        @include('superadmin.dashboard.auth.layouts.alerts')
                        <br>
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_new_password_form" action="{{ route('super_admin_dashboard.changePassword') }}" method="post">
                            @csrf
