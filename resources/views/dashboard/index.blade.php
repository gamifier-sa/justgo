                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <!--begin::Value-->
                                        <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.companies') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span class="symbol-label bg-gray  text-inverse fw-bold">{{ $companies }}</span>
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <span class="symbol-label bg-light  text-inverse fw-bold">
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-gray  text-inverse fw-bold">{{ $services }}</span>
                                        </div>
                                    </span>
                                    <!--end::Description-->
                                </div>
                        ...
                        <div class="card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--begin::Subtitle-->
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span class="symbol-label bg-light  text-inverse fw-bold">{{ $categories->count() }}
                                        </span>
                                    </div>
                                    <!--end::Subtitle-->
                                </div>
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <!--begin::Value-->
                                        <span
                                            class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.brands') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <span class="symbol-label bg-light  text-inverse fw-bold">
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-gray  text-inverse fw-bold">{{ $brands }}</span>
                                        </div>
                                    </span>
                                    <!--end::Description-->
                                </div>
                        ...
                        <div class="card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span
                                            class="symbol-label bg-light  text-inverse fw-bold">{{ $regions }}</span>
                                    </div>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                        ...
                                        <span class="fw-bold fs-6 text-gray-400">{{ $regions }}%</span>
                                    </div>
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <span class="fs-6 fw-semibold text-gray-400">Total {{ __('admin.awards') }}
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-light  text-inverse fw-bold">{{ $awards }}</span>
                                        </div>
