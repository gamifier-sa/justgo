    ...
    var initDocsTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                {
                    targets: 2, // Index of the "cover_image" column
                    render: function (data) {
                        return `<img src="/storage/Events/${data}" width="100" height="100" />`; // Adjust the width and height as needed
                    },
                },
                {
                    targets: -1,
            ...
            deleteSelected.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        ).length; // will return count of checked checkboxes;
