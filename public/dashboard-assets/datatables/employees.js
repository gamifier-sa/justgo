        ...
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        if(data != 'active'){
                            return `<button class="btn btn-danger btn-sm revisar"> ${translate("Not Active")}</button>`;

                        }else{
                            return `<button class="btn btn-success btn-sm revisar"> ${translate("Active")}</button>`;
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="${route}/${
                            row.id
                        }/edit" class="menu-link px-3 d-flex justify-content-between" data-kt-docs-table-filter="edit_row">
